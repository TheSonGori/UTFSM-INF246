...
//-------------------FUNCIONES-------------------//
void buscar_palabra( char *palabra,  char *linea, int num,  char *tipo, int *encontrada) {
    /*
...
void EspaciosVertical(char matrix[500][500], int rows, int cols) {
    /*
    ELIMINA LOS ESPACIOS EN BLANCO DE UNA MATRIZ DE CARACTERES VERTICALMENTE
    */
    for (int i = 0; i < rows; i++) {
        int j = 0;
        for (int k = 0; k < cols; k++) {
            if (!isspace(matrix[i][k])) {
...
void MinusculaVertical(char matrix[500][500], int rows) {
    /*
    CONVIERTE LOS CARACTERES DE UNA MATRIZ DE CARACTERES A MINUSCULAS VERTICALMENTE
    */
    for (int i = 0; i < rows; i++) {
...
void EspaciosHorizontal(char* line) {
    /*
    ELIMINA LOS ESPACIOS EN BLANCO DE UNA MATRIZ DE CARACTERES HORIZONTALMENTE
    */
    int j = 0;
...
void MinusculaHorizontal(char* line) {
    /*
    CONVIERTE LOS CARACTERES DE UNA MATRIZ DE CARACTERES A MINUSCULAS HORIZONTALMENTE
    */
    for (int i = 0; line[i]; i++) {
...
void horizontal(char *nombreArchivo, char *palabra) {
    /*
    ...
    */
    ...
    while (fgets(line, sizeof(line), file) != NULL) {
        ...
        EspaciosHorizontal(line);
        MinusculaHorizontal(line);
    ...
    double segundos = (double)(end_time - start_time) / CLOCKS_PER_SEC; 
...
void vertical( char *nombreArchivo,  char *palabra) {
    /*
    PROCESA EL ARCHIVO DE TEXTO DE LA PALABRA A ENCONTRAR, ESPECIFICAMENTE LAS
    ...
    */
    ...
    EspaciosVertical(matrix, rows, cols);
    MinusculaVertical(matrix, rows);
...
int contarLineasArchivo( char *nombreArchivo, char *primeraLinea) {
    /*
